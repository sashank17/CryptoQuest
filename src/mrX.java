...
public class mrX extends JFrame {

    private ClientSideConnection csc;

    private final JLabel move;
    private final JLabel turn;
    private final JLabel mrX;
    private final JLabel cop1;
    private final JLabel cop2;
    private final JLabel cop3;
    private final JLabel Heading;
    private final JLabel Functions;
    private final JLabel Powerups;
    private final JLabel powerupsLeft;
    private final JLabel BlackTicketLeft;
    private final JLabel DoubleLeft;
    private final JLabel GetCharLeft;
    private final JLabel MastermindLeft;
    private final JButton FullReverse;
    private final JButton AltSwap;
    private final JButton LeftShift;
    private final JButton RightShift;
    private final JButton Double;
    private final JButton Mastermind;
    private final JButton GetChar;
    private final JButton BlackTicket;
    private final Container contentPane;
    private final JButton startGame;
    private final JLabel CQImage;
    private final JTextField ParticipantName;
    private final JTextField SchoolName;
    private final JLabel participantName;
    private final JLabel schoolName;


    private String bMove, bPos,PName, SName;
...
//        this.setSize(1400,750);
        ...
        this.setTitle("CryptoQuest: Mr. X");
    ...
    public void setUpGUI() {
        ...
        RightShift.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                mrX.setText("Mr. X: " + f.RightShift(mrX.getText().substring(7)));
                move.setText("Move: Cyclic Shift");
                bMove = RightShift.getText();
                bPos = mrX.getText().substring(7);
                csc.sendMoveAndPos(bMove, bPos, TURN, d, bt);
                bt = 0;
            }
        });
        ...
        LeftShift.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                mrX.setText("Mr. X: " + f.LeftShift(mrX.getText().substring(7)));
                move.setText("Move: Cyclic Shift");
        ...
        AltSwap.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                mrX.setText("Mr. X: " + f.AltSwap(mrX.getText().substring(7)));
        ...
        FullReverse.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                mrX.setText("Mr. X: " + f.FullReverse(mrX.getText().substring(7)));
                move.setText("Move: Swap");
        ...
        Double.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                bMove = Double.getText();
                Double.setEnabled(false);
                BlackTicket.setEnabled(false);
                d = 1;
                if (dl <= 0) {
                    JOptionPane.showMessageDialog(null, "Sorry, no more Double Powerup left");
                    d = 0;
                } else {
                    JOptionPane.showMessageDialog(null, "You can perform two moves in this turn");
                    csc.sendMoveAndPos(bMove, "none", TURN, d, bt);
                }
            }
        });

        BlackTicket.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                bMove = BlackTicket.getText();
                Double.setEnabled(false);
                BlackTicket.setEnabled(false);
                bt = 100;
                if (btl <= 0) {
                    JOptionPane.showMessageDialog(null, "Sorry, no more BlackTicket Powerup left");
                    bt = 0;
                } else {
                    csc.sendMoveAndPos(bMove, "none", TURN, d, bt);
                }
    ...
    public void toggleButtons() {
        ...
        Double.setEnabled(ButtonEnabled);
        BlackTicket.setEnabled(ButtonEnabled);
    }
    ...
    public void update() {
        ...
        if (s[1].equals("none")) {
            ...
            updatePos(s[1], Integer.parseInt(s[2]));
        }
    }

    public void updatePos(String s, int n) {
        if (n == 0) {
            MOVE++;
            mrxPos = s;
            if (d==1) {
    ...
    public void checkWinner(String s1, String s2, String s3, String s4) {
        ...
        if(s1.equals(s2) || s1.equals(s3) || s1.equals(s4)) {
            JOptionPane.showMessageDialog(null, "Sorry!! The cops caught you.\n You Lose.");
            csc.closeConnection();
        } else if (MOVE == 20) {
            JOptionPane.showMessageDialog(null, "Congratulations!! You successfully outran the cops.\n You Win.");
            csc.closeConnection();
        }
    }
    ...
    public class ClientSideConnection {
        ...
        public ClientSideConnection() {
            ...
            try {
                ...
                System.out.println("Mr. X Connected to server as client # " + playerID + ".");
            } catch (IOException ex) {
                System.out.println("IOException from CSC Constructor");
            }
        }

        public void sendMoveAndPos(String s1, String s2, int n, int dp, int btp) {
            try {
                dataOut.writeInt(n);
                dataOut.flush();
                dataOut.writeUTF(s1);
