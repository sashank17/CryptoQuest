...
public class cop1 extends JFrame {
    ...
    private int TURN = 1, dl = 2, btl = 2, gcl = 7, mml = 7, m = 0, MOVE = 0;
...
//        this.setSize(1400,750);
        ...
        this.setTitle("CryptoQuest: Cop 1");
    ...
    public void setUpGUI(){
        ...
        RightShift.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                cop1.setText("Cop 1: " + f.RightShift(cop1.getText().substring(7)));
                move.setText("Move: Cyclic Shift");
                bMove = RightShift.getText();
                bPos = cop1.getText().substring(7);
        ...
        LeftShift.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                cop1.setText("Cop 1: " + f.LeftShift(cop1.getText().substring(7)));
                move.setText("Move: Cyclic Shift");
        ...
        AltSwap.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                cop1.setText("Cop 1: " + f.AltSwap(cop1.getText().substring(7)));
        ...
        FullReverse.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                cop1.setText("Cop 1: " + f.FullReverse(cop1.getText().substring(7)));
                move.setText("Move: Swap");
    ...
    public void checkWinner(String s1, String s2, String s3, String s4) {
        ...
        if(s1.equals(s2) || s1.equals(s3) || s1.equals(s4)) {
            JOptionPane.showMessageDialog(null, "Congratulations!! The cops have caught the wicked Mr. X \nYou win.");
            csc.closeConnection();
        } else if (MOVE == 20) {
    ...
    private class ClientSideConnection {
        ...
        public ClientSideConnection() {
            ...
            try {
                ...
                System.out.println("Cop 1 Connected to server as client # " + playerID + ".");
