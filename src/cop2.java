...
public class cop2 extends JFrame {
    ...
    private int TURN = 2, dl = 2, btl = 2, gcl = 7, mml = 7, m = 0, MOVE = 0;
...
//        this.setSize(1400,750);
        ...
        this.setTitle("CryptoQuest: Cop 2");
    ...
    public void setUpGUI() {
        ...
        RightShift.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                cop2.setText("cop 2: " + f.RightShift(cop2.getText().substring(7)));
                move.setText("Move: Cyclic Shift");
                bMove = RightShift.getText();
                bPos = cop2.getText().substring(7);
        ...
        LeftShift.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                cop2.setText("Cop 2: " + f.LeftShift(cop2.getText().substring(7)));
                move.setText("Move: Cyclic Shift");
        ...
        AltSwap.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                cop2.setText("Cop 2: " + f.AltSwap(cop2.getText().substring(7)));
        ...
        FullReverse.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                cop2.setText("Cop 2: " + f.FullReverse(cop2.getText().substring(7)));
                move.setText("Move: Swap");
    ...
    private class ClientSideConnection {
        ...
        public ClientSideConnection() {
            ...
            try {
                ...
                System.out.println("Cop 2 Connected to server as client # " + playerID + ".");
